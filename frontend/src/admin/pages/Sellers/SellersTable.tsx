...
export const accountStatus = [
  {
    ...
    description: "Account is created but pending verification."
  },
  {
    status: "ACTIVE",
    title: "Active",
  ...
  },
  {
    status: "SUSPENDED",
    title: "Suspended",
    description: "Account is temporarily suspended due to policy violation."
  },
  {
    status: "DEACTIVATED",
    title: "Deactivated",
  ...
  },
  {
    status: "BANNED",
    title: "Banned",
    description: "Account is permanently banned due to serious violations."
  },
  {
    status: "CLOSED",
    title: "Closed",
    description: "Account is permanently closed and cannot be restored."
  }
];
        ...
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="right">Buissiness Name</StyledTableCell>
