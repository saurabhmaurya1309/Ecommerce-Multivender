                ...
                <div className='flex items-center justify-between px-5 lg:px-20 h-[70px] border-b'>
                    <div className='flex items-center gap-9'>
                        <div className='flex items-center gap-2'>
                            ...
                            <h1 onClick={()=>navigate('/')} className='logo cursor-pointer whitespace-nowrap text-lg md:text-2xl text-primary-color '>
                                Super Market
                            </h1>
                        </div>
                    ...
                    <div className='flex items-center gap-1 lg:gap-2'>
                        ...
                        </IconButton>
                        {
                            auth.isLoggedIn ?
                                <Button onClick={()=>navigate('/account/orders')} className='flex items-center gap-2'>
                                    ...
                                    <h1 className='font-semibold  lg:block'>
                        ...
                        {isLarge &&
                            ...
                            className='whitespace-nowrap' startIcon={<Storefront />} variant='outlined'>Become Seller</Button>
