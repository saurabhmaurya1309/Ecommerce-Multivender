            ...
            <StyledTableRow key={item.id}> 
              <StyledTableCell component="th" scope="row">
                <div className='flex gap-1 flex-wrap'>
                  {item.images.map((image) => <img className='w-20 rounded-md' src={image} alt={item.title} />)}
                </div>
              </StyledTableCell>
              ...
              <StyledTableCell align="right"><IconButton size='small'><Edit color='primary' /></IconButton></StyledTableCell>
