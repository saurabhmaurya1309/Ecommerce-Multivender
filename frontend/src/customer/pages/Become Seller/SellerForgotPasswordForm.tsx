...
import { resetOtpState, resetSellerPassword, sendLoginSignupOtp } from "../../../State/AuthSlice";
...
const SellerForgotPasswordForm = ({ switchToLogin, }: Props) => {
...
export default SellerForgotPasswordForm;